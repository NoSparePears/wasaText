...
var (
	query_INSERT_MESSAGE  = `INSERT INTO Message (convoID, senderID, content, isPhoto, isForwarded) VALUES (?, ?, ?, ?, ?);`
...
func (db *appdbimpl) InsertMessage(msg structs.Message) (int, string, error) {
